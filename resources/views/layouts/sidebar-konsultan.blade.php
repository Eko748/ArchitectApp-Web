    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::segment(2) == 'dashboard' ? 'active' : '' }}"><a class="nav-link"
                    href="{{ route('konsultan.dashboard') }}"><i class="fas fa-fire"></i><span>Dashboard</span></a></li>
            <li class="menu-header">Product</li>
            <li class=" {{ Request::segment(2) == 'project' ? 'active' : '' }}"><a class="nav-link"  href="{{ route('konsultan.project') }}"><i class="far fa-images"></i><span>Project</span></a></li>
            <li class="menu-header">Management</li>
            <li class=" {{ Request::segment(2) == 'lelang' ? 'active' : '' }}"><a class="nav-link"  href="{{ route('konsultan.find') }}"><i class="far fa-images"></i><span>Find Work</span></a></li>
            <li class="nav-item dropdown  {{ in_array(Request::segment(3),['active-job','archived-job']) ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::segment(3) == 'active-job' ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('konsultan.job.active') }}">Active Jobs</a></li>
                    <li class="{{ Request::segment(3) == 'archived-job' ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('konsultan.job.archived') }}">Archived Jobs</a></li>
                </ul>
            </li>

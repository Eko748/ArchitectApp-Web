        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="{{ route('public.landing') }}"
                    ...
                    <img src="{{ asset('img/logo_proyek.png') }}" alt="logo" width="100" class=" mb-0 mt-0">
                </a>
                ...
                @guest
                    <div class="ms-auto">
                        <a href="{{ route('login') }}" style="font-size: 18px;"
                            class="btn btn-light btnChangeTheme btn btn-outline-dark btn-sm border-0 ml-3 shadow-none">Login</a>
                        <a href="{{ route('choose.account') }}" style="font-size: 18px;"
                            class="btn btn-warning btnChangeTheme btn btn-outline-dark btn-sm border-0 ml-3 shadow-none">Sign
                            Up</a>
            ...
            <div class="dropdown tema">
                ...
                <div class="dropdown-content">
                    ...
                    <a class="nav-link text-dark dropdown-item"
                        href="{{ route('public.kontraktor') }}">Kontraktor</a>
                </div>
            </div>
            @auth

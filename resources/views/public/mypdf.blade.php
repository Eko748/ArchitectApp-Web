...
<body>
    ...
    <P>Nama <span>:</span> {{$konsName}}</p>
    <P>Telepon <span>:</span> {{$konsTelp}}</p>
    <p>Alamat <span>:</span> {{$konsAlm}}</p>
    bertindak sebagai konsultan yang dalam hal ini disebut sebagai PIHAK KEDUA

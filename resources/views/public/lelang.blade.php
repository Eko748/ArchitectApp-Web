                ...
                <div class="my-4">
                    ...
                    <form action="{{ route('owner.lelang.post') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="from" class="form-label form-label-sm">Mulai</label>
                                ...
                                <div class="col-md-6">
                                    <label for="to" class="form-label form-label-sm">Sampai</label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>

                                        <input type="text"
                                            class="form-control form-control-sm @error('to') is-invalid @enderror" name="to"
                                            value="{{ old('to') }}" id="to">
                        ...
                        <label class="form-label" for="designstyle">Gaya desain<span
                                class="text-danger fw-bolder">*</span></label>
                        <div class="input-group mb-3">
                            <select class="form-select form-select-sm @error('designstyle') is-invalid @enderror"
                                id="designstyle" name="designstyle">
                        ...
                        <div class="mb-3">
                            <label for="desc" class="form-label">Deskripsi<span
                                    class="text-danger fw-bolder">*</span></label>
                            <textarea type="text" class="form-control form-control-sm @error('desc') is-invalid @enderror"
                                name="desc" id="desc" rows="5" value="">{{ old('desc') }}</textarea>
                            @error('desc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

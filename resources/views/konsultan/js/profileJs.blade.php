<script>
    $(function() {
        ...
        $("#editProfile").click(function() {
            ...
            let url = "{{ route('konsultan.profile.edit', Auth::user()->id) }}";
            let Showurl = "{{ route('konsultan.profile.show', Auth::user()->id) }}";
            let id = {{Auth::user()->id}}
            $.ajax({
                url: Showurl,
                dataType: "JSON",
                ...
                success: function(response) {
                    ...
                    $("#telepon").val(response.konsultan.telepon)
                    $("#website").val(response.konsultan.website)
                    $("#alamat").val(response.konsultan.alamat)
                    $("#instagram").val(response.konsultan.instagram)
                    $("#about").val(response.konsultan.about)
                },
            });
            removeInvalid();
        ...
        $("#editAva").click(function() {
            ...
            $("#formAva").submit(function(e) {
                ...
                SetupAjax();
                $.ajax({
                    url: "{{ route('konsultan.profile.ava', Auth::user()->id) }}",
                    dataType: "JSON",
                    type: "POST",
    ...
    function loadUser() {
        let url = "{{ route('konsultan.profile.show', Auth::user()->id) }}"
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#about-readonly").val(response.konsultan.about);
                $("#alamat-readonly").val(response.konsultan.alamat);
                $("#ig-readonly").val(response.konsultan.instagram);
                $("#web-readonly").val(response.konsultan.website);
                $("#telepon-readonly").val(response.konsultan.telepon);

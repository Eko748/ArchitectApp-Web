                ...
                <div class="row">
                    <div class="col-lg-4 col-md col-sm">
                        ...
                        <div class="card card-primary">
                            ...
                            <textarea type="text" id="about_readonly" class="form-control h-100" rows="3" readonly></textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="nama">Telepon</label>
                                        <input type="text" class="form-control" id="telepon-readonly" readonly >
                                </div>
                                <div class="form-group">
                                    <label for="nama">Instagram</label>
                                        <input type="text" class="form-control" id="ig-readonly" readonly >
                                </div>
                                <div class="form-group">
                                           <label for="nama">Website</label>
                                        <input type="text" class="form-control" id="web-readonly" readonly >
                                </div>
                ...
                <div class="modal-body">
                    <form action="" method="post" id="formProfile">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alamat" id="alamat" class="form-control" maxlength="13">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                            <label for="telepon">Telepon</label>
                            <input type="text" name="telepon" id="telepon" class="form-control" maxlength="13">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="text">About</label>
                            <textarea type="text" name="about" id="about" class="form-control h-100" rows="3"></textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                </div>

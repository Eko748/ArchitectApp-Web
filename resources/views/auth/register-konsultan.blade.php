    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm col-md col-lg-4">
                ...
                <form method="POST" action="{{ route('daftar.konsultan') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="form-label" class="custom-control-label" for="agree">Saya setuju dengan syarat dan ketentuan</label>
                        </div>
                    </div>
